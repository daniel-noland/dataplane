...
pub use n_vm_protocol::{
    CONTAINER_IMAGE, CONTAINER_PLATFORM, ENV_IN_TEST_CONTAINER, ENV_IN_VM, ENV_MARKER_VALUE,
    HYPERVISOR_API_SOCKET_PATH, INIT_SYSTEM_VSOCK_PORT, KERNEL_CONSOLE_SOCKET_PATH,
    VHOST_VSOCK_SOCKET_PATH, VIRTIOFSD_SOCKET_PATH, VIRTIOFS_ROOT_TAG, VM_GUEST_CID,
