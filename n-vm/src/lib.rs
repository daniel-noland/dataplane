...
pub use n_vm_protocol::{
    CLOUD_HYPERVISOR_BINARY_PATH, CONTAINER_IMAGE_DEFAULT, CONTAINER_PLATFORM,
    ENV_CONTAINER_IMAGE, ENV_IN_TEST_CONTAINER, ENV_IN_VM, ENV_MARKER_VALUE, ENV_TEST_ROOT,
    ENV_VM_ROOT, HYPERVISOR_API_SOCKET_PATH, INIT_BINARY_PATH, KERNEL_CONSOLE_SOCKET_PATH,
    KERNEL_IMAGE_PATH, QEMU_BINARY_PATH, VHOST_VSOCK_SOCKET_PATH, VIRTIOFS_ROOT_TAG,
    VIRTIOFSD_BINARY_PATH, VIRTIOFSD_SOCKET_PATH, VM_GUEST_CID, VM_ROOT_SHARE_PATH, VM_RUN_DIR,
    VsockChannel, VsockCid, VsockPort,
    container_image, ScratchRootError, ScratchRoots,
};
pub use qemu::Qemu;
